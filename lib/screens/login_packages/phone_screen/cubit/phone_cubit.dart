...
import 'package:smart_prescription/screens/login_packages/phone_screen/cubit/phone_state.dart';
    ...
    FirebaseFirestore.instance
      ...
      if (value.exists) {
        if (value.data()!['isDoctor'] == true) {
          emit(PhoneOTPVerifiedMainLayoutDoctor());
        } else {
          emit(PhoneOTPVerifiedMainLayoutPatient());
        }
      } else {
