...
import 'package:smart_prescription/screens/complete_profile/components/custom_toggle_doctor.dart';
import 'package:smart_prescription/screens/complete_profile/components/doctor_specialization.dart';
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: getProportionateScreenHeight(20)),
                cubit.isDoctorList[0] ?  CustomTextFormField(
